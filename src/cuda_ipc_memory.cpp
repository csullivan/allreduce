...
void CUDAIpcMemory::allocateAndShare() {
  ...
  cudaMemcpy(d_allHandles + rank * CUDA_IPC_HANDLE_SIZE, serializedHandle, CUDA_IPC_HANDLE_SIZE,
             cudaMemcpyHostToDevice);

  ncclAllGather(d_allHandles + rank * CUDA_IPC_HANDLE_SIZE, d_allHandles, CUDA_IPC_HANDLE_SIZE,
                ncclChar, ncclComm, 0);
